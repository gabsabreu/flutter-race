...
import 'package:meuapp/shared/theme/widgets/chart_horizontal/chart_horizontal.dart';
...
class CardChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        height: 216,
        decoration: BoxDecoration(color: AppTheme.colors.textEnabled, borderRadius: BorderRadius.circular(10)),
        child: Padding(
